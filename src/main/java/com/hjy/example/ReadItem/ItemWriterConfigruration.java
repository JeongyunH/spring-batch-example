...
@Configuration
@Slf4j
public class ItemWriterConfigruration {
    ...
    public ItemWriterConfigruration(JobBuilderFactory jobBuilderFactory, StepBuilderFactory stepBuilderFactory, DataSource dataSource, EntityManagerFactory entityManagerFactory) {
...
//                .next(this.jdbcBatchItemWriterStep())
    ...
    private ItemWriter<Person> csvFileItemWriter() throws Exception {
        ...
        FlatFileItemWriter<Person> itemWriter = new FlatFileItemWriterBuilder<Person>()
                ...
                .headerCallback(writer -> writer.write("id, 이름, 나이, address"))
